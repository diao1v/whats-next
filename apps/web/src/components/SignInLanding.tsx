    ...
    <div className="grid min-h-screen md:grid-cols-2">
      <div className="flex flex-col justify-center gap-4 bg-gradient-to-br from-[#fbe7c6] to-[#fdf3e3] p-10">
        ...
        <ul className="space-y-1.5 text-sm text-[#7c5e3b]">
          <li className="flex items-center gap-2"><Check size={15} className="text-primary" /> Paste a URL — we extract the details</li>
          <li className="flex items-center gap-2"><Check size={15} className="text-primary" /> Track stages from Saved to Offer</li>
          <li className="flex items-center gap-2"><Check size={15} className="text-primary" /> See salary, skills &amp; next steps at a glance</li>
        </ul>
      </div>
