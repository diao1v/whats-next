  ...
  return (
    <div>
      ...
      <div className="overflow-hidden rounded-xl border border-line bg-paper shadow-card">
        <div className="grid grid-cols-[2.4fr_1.2fr_1fr_1.2fr] gap-2 border-b border-line bg-[#faf1e6] px-4 py-2 text-[10px] font-bold uppercase tracking-wide text-muted">
